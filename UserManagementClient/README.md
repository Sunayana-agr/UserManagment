...
## About The Project
[npx create-react-app UserManagementClient --template all](https://github.com/chaurasiawadh/cra-template-all)
...
. 
   ```sh
   npx create-react-app UserManagementClient --template all
   ```
